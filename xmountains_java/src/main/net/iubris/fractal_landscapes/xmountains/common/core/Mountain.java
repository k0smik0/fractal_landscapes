package net.iubris.fractal_landscapes.xmountains.common.core;
...
final  double mean=0.0;  // Mean height
  ...
  double mix=0.0;
  double midmix=0.0;
  public double fdim=0.65;
  int levels=10;
  int stop=2;
  public int width;        /* width of surface in points */
  public double fwidth;    /* width of surface 
