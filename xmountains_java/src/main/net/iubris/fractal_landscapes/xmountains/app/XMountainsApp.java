...
public class XMountainsApp extends JFrame implements Runnable, MouseListener, DummyApplet {
...
//			{ "snooze", "miliseconds", "Sleep time between columns" } };
	...
	public XMountainsApp(Parameter parameter) {
		super();
		setSize(512, 384);
...
//			snooze = 10;
	...
	public static void main(String[] args) {
			...
			XMountainsApp mountappSuperFrame = new XMountainsApp(parameter);
